  ...
  return (
    <div className="dashboard-container" style={{ background: 'var(--bg-primary)', minHeight: '100vh' }}>
      ...
      <div className="premium-container">
        ...
        {/* Header Section */}
        <div className="dashboard-header" style={{ textAlign: 'center', marginBottom: '3rem', padding: '4rem 0 2rem' }}>
          ...
          <p className="dashboard-subtitle"
            style={{ fontSize: '1.3rem', color: 'var(--text-secondary)', maxWidth: '600px', margin: '0 auto', lineHeight: '1.6' }}>
        ...
        <div className="stats-grid-premium"
          ...
          {[
            { icon: '🏠', number: stats.totalProperties, label: 'Total Properties' },
            { icon: '✅', number: stats.available, label: 'Available' },
            { icon: '👥', number: stats.occupied, label: 'Occupied' }
          ].map((stat, index) => (
            <div key={index}
            ...
            >
              <div style={{ fontSize: '3rem', marginBottom: '1.5rem' }}>{stat.icon}</div>
              ...
              <div style={{ color: 'var(--text-muted)', fontSize: '0.9rem', textTransform: 'uppercase' }}>
                {stat.label}
              </div>
            </div>
          ))}
        ...
        <div className="tabs"
          ...
          <div className="tab-list" style={{ display: 'flex', background: 'rgba(90, 122, 110, 0.05)' }}>
            {[
