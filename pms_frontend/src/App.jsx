          ...
          <div className="hero-content">
            <div className="hero-text">
              ...
              <p className="hero-subtitle">
                Discover thousands of verified rental properties or list your
                own. Join our community of satisfied homeowners and tenants.
              </p>
        ...
        <div className="premium-container">
          <div className="section-header">
            ...
            <p className="section-subtitle">
              Experience the best in property rental with our premium features
            </p>
          </div>
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p>
                All properties and users are thoroughly verified for your safety
                and peace of mind.
              </p>
            </div>
            <div className="feature-card">
              ...
              <p>
                Book your dream property instantly with our streamlined rental
                process.
              </p>
            </div>
            <div className="feature-card">
              ...
              <h3>Best Prices</h3>
              <p>
                Get the best deals with no hidden charges or brokerage fees.
              </p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">🏆</div>
              ...
              <p>
                24/7 customer support to help you with all your rental needs.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="premium-container">
          ...
          <div className="steps-container">
            ...
            <div className="step">
              ...
              <h3>Find or List</h3>
              <p>
                Browse properties or list your own with detailed information
              </p>
            </div>
            <div className="step">
            ...
            <div className="cta-buttons">
              {!user ? (
                <>
                  ...
                  <Link
                    to="/login"
                    className="btn-premium btn-secondary btn-large"
                  >
                    Sign In
                  </Link>
                </>
      ...
      <Router>
        <div className="App">
          <Routes>
            ...
            <Route
              path="/lease/preview/:leaseId?"
              element={<TenantLeasePreview />}
            />
            ...
            <Route
              path="/tenant/leased-properties"
              element={<LeasedProperties />}
            />
            <Route
              path="/maintenance/create"
              element={<CreateMaintenanceTicket />}
            />
            <Route
