...
/units?propertyId=${id}`, {
        ...
        <div className="premium-container">
          <div className="empty-state" style={{
            ...
            <p style={{
              ...
              marginBottom: '2.5rem',
              fontSize: '1.1rem'
            }}>The property you're looking for doesn't exist.</p>
  ...
  const minRent = availableUnits.length > 0 
      ...
      <div className="premium-container" style={{maxWidth: '1200px', margin: '0 auto', padding: '0 1rem'}}>
        ...
        <div className="property-detail-header" style={{
          ...
          <div className="property-detail-info" style={{padding: '1rem 0'}}>
            <div className="property-badge large" style={{
              display: 'inline-block',
              background: 'var(--primary-gradient)',
              color: 'white',
            ...
            <h1 className="property-detail-title" style={{
              fontSize: '3rem',
              fontWeight: '800',
              color: 'var(--text-primary)',
              marginBottom: '1rem',
            ...
            <div className="property-detail-price" style={{
              fontSize: '2.5rem',
              fontWeight: '800',
              background: 'var(--gradient-hero)',
              WebkitBackgroundClip: 'text',
              ...
              <span style={{
                ...
                fontWeight: '500',
                marginLeft: '0.5rem'
              }}>/month starting from</span>
            </div>
            
            <div className="property-detail-stats" style={{
              display: 'flex',
              gap: '3rem',
              marginBottom: '2.5rem',
              padding: '1.5rem',
            ...
            <div className="property-description-preview" style={{
              color: 'var(--text-secondary)',
              lineHeight: '1.7',
              fontSize: '1.2rem',
              padding: '1.5rem',
              ...
              {property.description || 'A beautiful property in a great location with modern amenities and convenient access to local facilities.'}
            </div>
          </div>
        </div>

        {/* Property Description */}
        <div className="property-detail-section" style={{
          background: 'var(--bg-card)',
          padding: '2.5rem',
          borderRadius: '20px',
          boxShadow: 'var(--shadow-lg)',
          ...
          {availableUnits.length === 0 ? (
            <div className="empty-state" style={{
              ...
              <h3 style={{
                ...
                marginBottom: '1rem',
                fontWeight: '700'
              }}>No Units Available</h3>
              <p style={{
                color: 'var(--text-secondary)',
                fontSize: '1.1rem'
              }}>All units in this property are currently occupied.</p>
            </div>
          ) : (
            <div className="units-grid detailed" style={{
              display: 'grid',
              gridTemplateColumns: 'repeat(auto-fill, minmax(400px, 1fr))',
              gap: '2rem'
            }}>
              {availableUnits.map(unit => (
                <div key={unit._id} className="unit-card detailed" style={{
                  ...
                  <div className="unit-content" style={{padding: '2rem'}}>
                    <div className="unit-header" style={{
                      ...
                      <div className="unit-price" style={{
                        ...
                        fontWeight: '800',
                        color: 'var(--accent-teal)'
                      }}>${unit.rentAmount}/month</div>
                    </div>
                    
                    <div className="unit-details" style={{
                      display: 'grid',
                      gap: '1rem',
                      marginBottom: '2rem'
                    }}>
                      <div className="unit-detail" style={{
                        display: 'flex',
                        justifyContent: 'space-between',
                        padding: '0.75rem',
                        background: 'rgba(102, 126, 234, 0.05)',
                      ...
                      {unit.bedrooms && (
                        <div className="unit-detail" style={{
                          ...
                          <strong style={{color: 'var(--text-primary)'}}>Bedrooms:</strong> 
                          <span style={{color: 'var(--text-secondary)'}}>{unit.bedrooms}</span>
                        </div>
                      )}
                      ...
                      {unit.bathrooms && (
                        <div className="unit-detail" style={{
                          ...
                          <strong style={{color: 'var(--text-primary)'}}>Bathrooms:</strong> 
                          <span style={{color: 'var(--text-secondary)'}}>{unit.bathrooms}</span>
                        </div>
                      )}
                      ...
                      {unit.sqft && (
                        <div className="unit-detail" style={{
                          ...
                          <strong style={{color: 'var(--text-primary)'}}>Square Feet:</strong> 
                          <span style={{color: 'var(--text-secondary)'}}>{unit.sqft} sqft</span>
                        </div>
                      )}
                      ...
                      <div className="unit-detail" style={{
                        ...
                        <span style={{color: 'var(--text-secondary)'}}>${unit.depositAmount || unit.rentAmount}</span>
                      </div>
                    </div>
        ...
        <div className="property-detail-section" style={{
          ...
          <p style={{
            ...
            For more information about this property or to schedule a viewing, please contact the property manager.
          </p>
          <div className="contact-actions" style={{
            ...
            <button className="btn-premium btn-primary" style={{
              padding: '1rem 2rem',
              background: 'var(--primary-gradient)',
              color: 'white',
              border: 'none',
